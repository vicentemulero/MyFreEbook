@extends('layouts.app')
@section('titulo', 'MyfreEbook - Búsqueda por género')
@section('content')
<div class="container">
    <a href="{{ URL::previous() }}"><i class="fas fa-long-arrow-alt-left"></i></a>
    <br>
    <br>
    <h3><i class="fas fa-search"></i> : <span id="spanSearchGenre">{{ $genreSearch->name }}</span></h3>
    <br>
    <div class="row">
        ...
        @empty
            <p> No hay libros con el género seleccionado</p>
        @endforelse
    </div>
</div>
@endsection
